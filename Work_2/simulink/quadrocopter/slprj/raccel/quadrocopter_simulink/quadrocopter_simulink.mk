...
MODEL                  = quadrocopter_simulink
MODULES                = rt_logging.c quadrocopter_simulink.c quadrocopter_simulink_capi.c quadrocopter_simulink_data.c quadrocopter_simulink_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE               = quadrocopter_simulink.mk
MATLAB_ROOT            = D:\Programs\MATLAB\R2019a
ALT_MATLAB_ROOT        = D:\Programs\MATLAB\R2019a
MATLAB_BIN             = D:\Programs\MATLAB\R2019a\bin
ALT_MATLAB_BIN         = D:\Programs\MATLAB\R2019a\bin
MASTER_ANCHOR_DIR      = 
START_DIR              = D:\SPbSU\Projects\Practice-on-computers-MATLAB-SPbSU\Work_2\quadrocopter
...
BUILDARGS              =  MODELLIB=quadrocopter_simulinklib.lib RSIM_SOLVER_SELECTION=2 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
RSIM_PARAMETER_LOADING = 1
ENABLE_SLEXEC_SSBRIDGE = 1
VISUAL_VER             = 15.0

SOLVER              = 
PCMATLABROOT        = D:\\Programs\\MATLAB\\R2019a
...
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = quadrocopter_simulink_ref.rsp
COMPILER_COMMAND_FILE     = quadrocopter_simulink_comp.rsp
...
raccel_main_new.obj : D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_main_new.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_main_new.c

raccel_sup.obj : D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_sup.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_sup.c

raccel_mat.obj : D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_mat.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\raccel\raccel_mat.c

ext_svr.obj : D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\ext_svr.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\ext_svr.c

updown.obj : D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\updown.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\updown.c

ext_work.obj : D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\ext_work.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\ext_work.c

rtiostream_interface.obj : D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\rtiostream_interface.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\rtw\c\src\ext_mode\common\rtiostream_interface.c

rtiostream_tcpip.obj : D:\Programs\MATLAB\R2019a\toolbox\coder\rtiostream\src\rtiostreamtcpip\rtiostream_tcpip.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\toolbox\coder\rtiostream\src\rtiostreamtcpip\rtiostream_tcpip.c

rtiostream_utils.obj : D:\Programs\MATLAB\R2019a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
	$(CC) $(CFLAGS) D:\Programs\MATLAB\R2019a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.c
